...
return new class extends Migration
{
    ...
    {
        // 1. Patch Artifacts
        if (! Schema::hasTable('patch_artifacts')) {
        ...
        // 2. Quality Gate Runs
        if (! Schema::hasTable('quality_gate_runs')) {
        ...
        if (! Schema::hasTable('quality_gate_checks')) {
        ...
        Schema::table('incidents', function (Blueprint $table) {
            if (! Schema::hasColumn('incidents', 'patch_iterations')) {
